...
INSERT INTO "new_Lojas" ("aberta", "ativa", "categoria_negocio", "cidade", "cor_primaria", "endereco", "forcar_status", "horario_abertura", "horario_fechamento", "horario_funcionamento", "id", "logo_url", "nome", "slug", "taxa_entrega", "telefone", "vencimento") SELECT "aberta", "ativa", "categoria_negocio", "cidade", "cor_primaria", "endereco", "forcar_status", "horario_abertura", "horario_fechamento", "horario_funcionamento", "id", "logo_url", "nome", "slug", "taxa_entrega", "telefone", "vencimento" FROM "Lojas";
DROP TABLE "Lojas";
