...
const schemaCupom = z.object({
  ...
  valor_desconto: z.number().positive('Valor do desconto deve ser positivo'),
  valor_minimo: z.number().min(0).nullable().optional().default(null),
  max_usos: z.number().int().positive().nullable().optional().default(null),
  usos_por_cliente: z.number().int().positive().nullable().optional().default(null),
