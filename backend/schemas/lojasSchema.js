...
const schemaLojas = z.object({
  ...
  titulo_ofertas: z.string().trim().min(1).optional().default('Ofertas'),
  ocultar_preco_destaques: z.boolean().optional().default(false),
...
const schemaLojasPut = z.object({
  ...
  titulo_ofertas: z.string().trim().min(1).optional(),
  ocultar_preco_destaques: z.boolean().optional(),
