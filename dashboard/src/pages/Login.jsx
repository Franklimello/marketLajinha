    ...
    <div className="min-h-screen bg-stone-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        ...
        <button
          ...
          disabled={carregando}
          className="w-full flex items-center justify-center gap-3 py-2.5 border border-stone-300 rounded-lg text-sm font-medium text-stone-700 hover:bg-stone-50 disabled:opacity-50 transition-colors mb-4"
        >
        ...
        <div className="relative mb-4">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-white px-3 text-stone-400">ou com e-mail</span>
          </div>
        </div>
